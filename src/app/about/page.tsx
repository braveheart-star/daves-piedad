        ...
        >
          ...
          <div className="space-y-6">
            <div>
              ...
              I&apos;m <strong>Kish Mark Piedad</strong>, a senior full-stack, AI, and automation engineer based in Caloocan City, Philippines. I architect and deliver production-grade systems end-to-end: modern React/Next.js, Vue, and Angular UIs; scalable services in Node/Python, Java/Spring Boot, and .NET Core; plus automation-ready data pipelines and intelligent workflow automation. Over 10+ years across startups and enterprise environments, I&apos;ve owned performance optimization, security best practices, cloud-native architecture (AWS), CI/CD pipelines, and pragmatic AI integrations (LLMs and computer vision) that ship measurable business value.
              </p>
            </div>
