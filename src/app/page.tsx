  ...
  const projects = [
    {
      ...
      technologies: ['Next.js', 'TailwindCSS', 'Java', 'Spring Boot', 'Python', 'PostgreSQL', 'Redis', 'Docker', 'AWS', 'TypeScript'],
  ...
  
    {
      ...
      description: 'Customer experience and feedback platform enhancements across web UI and integrations.',
      technologies: ['Vue.js', 'TypeScript', 'Node.js', 'TailwindCSS'],
    ...
    },
    {
      ...
      description: 'Medical supply chain technology and financing platform initiatives and dashboards.',
