    ...
    <form onSubmit={submitRequest}>
      <div className="justify-between text-sm lg:flex ">
        <div className="w-full px-2 my-2 lg:w-1/2 xl:w-5/12">
          <input
            name="name"
            value={payload.name}
            className="w-full p-2 px-5 my-1 text-gray-800 border-b focus:border-cyan-500 sm:text-base sm:p-3 focus:outline-none "
            placeholder="Name"
        ...
        <div className="w-full px-2 my-2 lg:w-1/2 xl:w-5/12 ">
          <input
            name="email"
            value={payload.email}
            className="w-full p-2 px-5 my-1 text-gray-800 border-b sm:text-base sm:p-3 focus:outline-none focus:border-cyan-500"
            placeholder="Email"
            onChange={onInputChange}
          />
        </div>
      ...
      <div className="w-full px-2 my-2 ">
        <textarea
          ...
          className="w-full h-40 p-2 px-5 my-1 text-gray-800 border lg:h-48 focus:border-cyan-500 sm:text-base sm:p-3 focus:outline-none"
          placeholder="Message"
          onChange={onInputChange}
        />
      </div>
      ...
      <div className="relative">
        <button
          type="submit"
          onClick={reSet}
          className="absolute right-0 bottom-auto p-2 px-6 mr-4 border rounded-md shadow bg-cyan-500 border-cyan-300 hover:bg-cyan-300 focus:outline-none"
        >
